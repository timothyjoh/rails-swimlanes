...
1. **MUST-FIX document**: `docs/phases/phase-1/MUST-FIX.md` — your task list
2. **Phase Review**: `docs/phases/phase-1/REVIEW.md` — full review context
3. **Phase Spec**: `docs/phases/phase-1/SPEC.md` — what was supposed to be built
4. **Phase Plan**: `docs/phases/phase-1/PLAN.md` — how it was supposed to be built
...
After all fixes are applied and tests pass, update `docs/phases/phase-1/MUST-FIX.md` by marking each task as done:
...
`touch /Users/timothyjohnson/wrk/rails-swimlanes/.pipeline/.step-done`