...
1. **Phase Spec**: `docs/phases/phase-5/SPEC.md` — what we're building
2. **Phase Research**: `docs/phases/phase-5/RESEARCH.md` — current codebase state
3. **Previous Reflections**: `Previous phase reflections (read this file): /Users/timothyjohnson/wrk/rails-swimlanes/docs/phases/phase-4/REFLECTIONS.md` — lessons from last phase (if exists)
...
Output to `docs/phases/phase-5/PLAN.md`:
